...
class ActionMakeCommandTest extends BaseTestCase
{
    ...
    public function test_generates_new_action_class()
    {
        ...
        $this->assertTrue(is_file($this->modulePath.'/app/Actions/MyAction.php'));
    ...
    public function test_generates_correct_file_with_content()
    {
        ...
        $file = $this->finder->get($this->modulePath.'/app/Actions/MyAction.php');
    ...
    public function test_generates_action_in_sub_folder()
    {
        ...
        $this->assertTrue(is_file($this->modulePath.'/app/Actions/Api/MyAction.php'));
        $file = $this->finder->get($this->modulePath.'/app/Actions/Api/MyAction.php');
        $this->assertMatchesSnapshot($file);
        $this->assertSame(0, $code);
    }
}
