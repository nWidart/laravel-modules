...
class EventProviderMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_a_new_event_provider_class()
    {
        ...
        $this->assertTrue(is_file($this->module_app_path('Providers/EventServiceProvider.php')));
    ...
    public function test_it_generated_correct_file_with_content()
    {
        ...
        $file = $this->finder->get($this->module_app_path('Providers/EventServiceProvider.php'));
