...
class HelperMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_a_new_helper_class()
    {
        ...
        $this->assertTrue(is_file($this->module_app_path('app/Helpers/MyHelper.php')));
    ...
    public function test_it_generated_correct_file_with_content()
    {
        ...
        $file = $this->finder->get($this->module_app_path('app/Helpers/MyHelper.php'));
    ...
    public function test_it_can_generate_a_helper_in_sub_namespace_in_correct_folder()
    {
        ...
        $this->assertTrue(is_file($this->module_app_path('app/Helpers/Api/MyHelper.php')));
        $this->assertSame(0, $code);
    }
    ...
    public function test_it_can_generate_a_helper_in_sub_namespace_with_correct_generated_file()
    {
        ...
        $file = $this->finder->get($this->module_app_path('app/Helpers/Api/MyHelper.php'));
