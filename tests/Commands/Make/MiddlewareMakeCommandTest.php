...
class MiddlewareMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_a_new_middleware_class()
    {
        ...
        $this->assertTrue(is_file($this->module_app_path('app/Http/Middleware/SomeMiddleware.php')));
    ...
    public function test_it_generated_correct_file_with_content()
    {
        ...
        $file = $this->finder->get($this->module_app_path('app/Http/Middleware/SomeMiddleware.php'));
    ...
    public function test_it_can_change_the_default_path()
    {
        ...
        $file = $this->finder->get($this->module_path('Middleware/SomeMiddleware.php'));
