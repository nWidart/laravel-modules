...
class ModuleMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_module_resources()
    {
        ...
        $path = $this->getModuleAppPath().'/app/Providers/BlogServiceProvider.php';
        ...
        $path = $this->getModuleAppPath().'/app/Providers/EventServiceProvider.php';
        $this->assertTrue($this->finder->exists($path));
        $this->assertMatchesSnapshot($this->finder->get($path));

        $path = $this->getModuleAppPath().'/app/Providers/RouteServiceProvider.php';
        $this->assertTrue($this->finder->exists($path));
        $this->assertMatchesSnapshot($this->finder->get($path));

        $path = $this->getModuleAppPath().'/app/Http/Controllers/BlogController.php';
        $this->assertTrue($this->finder->exists($path));
        $this->assertMatchesSnapshot($this->finder->get($path));
    ...
    public function test_it_generates_module_namespace_using_studly_case()
    {
        ...
        $file = $this->finder->get($this->getModuleAppPath('ModuleName').'/app/Providers/ModuleNameServiceProvider.php');
    ...
    public function test_it_generate_module_when_provider_is_enable_and_route_provider_is_enable()
    {
        ...
        $providerPath = $this->getModuleAppPath().'/app/Providers/BlogServiceProvider.php';
        $this->assertTrue($this->finder->exists($providerPath));
        $this->assertMatchesSnapshot($this->finder->get($providerPath));

        $RouteProviderPath = $this->getModuleAppPath().'/app/Providers/RouteServiceProvider.php';
