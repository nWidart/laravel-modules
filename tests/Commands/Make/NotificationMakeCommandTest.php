...
class NotificationMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_the_notification_class()
    {
        ...
        $this->assertTrue(is_file($this->modulePath.'/app/Notifications/WelcomeNotification.php'));
    ...
    public function test_it_generated_correct_file_with_content()
    {
        ...
        $file = $this->finder->get($this->modulePath.'/app/Notifications/WelcomeNotification.php');
