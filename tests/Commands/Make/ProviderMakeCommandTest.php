...
class ProviderMakeCommandTest extends BaseTestCase
{
    ...
    public function test_it_generates_a_service_provider()
    {
        ...
        $this->assertTrue(is_file($this->modulePath.'/app/Providers/MyBlogServiceProvider.php'));
    ...
    public function test_it_generated_correct_file_with_content()
    {
        ...
        $file = $this->finder->get($this->modulePath.'/app/Providers/MyBlogServiceProvider.php');
    ...
    public function test_it_generates_a_master_service_provider_with_resource_loading()
    {
        ...
        $file = $this->finder->get($this->modulePath.'/app/Providers/BlogServiceProvider.php');
